...
kable(graph_final_data_Group_50,caption="Summary: Geographical Data ")
```
...
The processing effort for the computer is enormously high, which is why the app sometimes crashes, especially when multiple radii are selected. Hence, a powerful computer is needed to run and use the app without problems.
