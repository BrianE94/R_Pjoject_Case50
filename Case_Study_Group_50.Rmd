...
```
Besides, it is nessecary to find the location of the vehicel. The "readr" and the "readexcel" package is used to import the data sets. Therefore, the documents "OpenGeoDB_bundesland_plz_ort_de (1)", "Zulassungen_alle_Fahrzeuge" and "Geodaten_Gemeinden_v1.2_2017-08-22_TrR" are imported. For "OpenGeoDB_bundesland_plz_ort_de (1)" cotains the information about the german state, places and postcode. Unfortunately, the data set is miising the place "Seeg", which was added by hand. This place was found by the later joining and evaluating the strucuture. Furthermore place items contains sometimes numbers, which were deleted by the use of the "tm" package.  
