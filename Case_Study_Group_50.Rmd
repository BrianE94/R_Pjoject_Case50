...
for (i in 1:nrow(data_Ort2)){
   calc <- as.integer(distm(c(data_Ort2_matrix[i,1],data_Ort2_matrix[i,2]),c(10.19271, 53.57436),fun=distGeo))
   dist[i]<-calc
}

#coord Hamburg 9.993682,53.551085
...
#Distance Calculation has been moved to "Creation of one Data Set" 
